...
void carroAvanzaAdelante(){
    ...
    analogWrite(pinVelocidadDerecha,VelocidadDerecha-anguloGrados*10);
    analogWrite(pinVelocidadIzquierda,VelocidadIzquierda+anguloGrados*10);
...
/*
    else(anguloGrados < -13 && anguloGrados > -16);{
    Serial.println("avanzando hacia adelante");
